            ...
            rows.append(
                {
                    ...
                    "attack": attack,
                    "source": "agentdojo_task_pair",
                    "selection_reason": selection_reason(labels, risk_types),
                    ...
                    "priority": "high" if "unsafe" in labels else "medium",
                }
            )
...
def select_balanced_pairs(
    ...
    risk_quota = min(len(unsafe) + len(mixed), max(2, limit // 3))
