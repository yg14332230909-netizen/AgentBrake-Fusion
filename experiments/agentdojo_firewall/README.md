...
```bash
pytest -q tests/eval_agentdojo_firewall
python experiments/agentdojo_firewall/scripts/smoke_agentdojo_firewall.py
```
...
```text
experiments/agentdojo_gateway_only/archive/deepseek_no_defense_baseline/
```
