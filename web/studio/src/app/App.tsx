  ...
  return (
    <>
      <header className="topbar">
        <div><h1>AgentBrake-Fusion Studio Pro</h1><p>看见通用智能体工具调用为什么被放行、沙箱执行、要求审批或阻断。</p></div>
          ...
          <div className="tab-page active">
            ...
            <div className="title-row">
              <div>
                ...
                <p className="muted">{store.selectedRun ? runSubtitle(store.selectedRun) : "选择左侧运行记录，查看 AgentBrake-Fusion 如何追踪来源、识别动作并做出安全决策。"}</p>
              </div>
